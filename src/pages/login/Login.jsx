...
import { loginUserWithGoogle, loginUserWithFacebook } from '../../redux/user/UserActions';
    ...
    render() {
        return(
            <div className="login-page">
                ...
                <button
                    className="btn btn-outline-dark d-flex m-1 align-items-center"
